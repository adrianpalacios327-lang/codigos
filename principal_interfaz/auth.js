...
(function () {
    ...
    const navCollapsible =
        document.getElementById("navCollapsible");
    ...
    function closeMobileMenu() {
        ...
        navCollapsible.classList.remove(
            "is-open"
        );
    ...
    function toggleMobileMenu() {
        ...
        const isOpen =
            navCollapsible.classList.toggle(
                "is-open"
            );
    ...
    if (
        ...
        navCollapsible.addEventListener(
            "click",
            (e) => {
        ...
        document.addEventListener(
            ...
            (e) => {
                ...
                if (
                    navCollapsible.classList.contains(
                        "is-open"
                    ) &&
                    !navCollapsible.contains(
                        e.target
                    ) &&
    ...
    if (signupForm) {
        ...
        signupForm.addEventListener(
            ...
            async (e) => {
                ...
                /* ====================================================
                   REGISTRO REAL EN FASTAPI + POSTGRESQL
                   ==================================================== */
                ...
                try {
                    ...
                    showToast(
                        "Cuenta creada. ¡Bienvenido a StudNova, " +
    ...
    if (loginForm) {
        ...
        loginForm.addEventListener(
            ...
            async (e) => {
                ...
                /* ====================================================
                   LOGIN REAL EN FASTAPI + POSTGRESQL
                   ==================================================== */
